<script lang="ts">
	...
	onMount(() => {
	  ...
	  tick().then(() => {
		observer = new IntersectionObserver(
		  (entries) => {
			if (entries[0].isIntersecting && hasNextPage && !$productsQuery.isFetchingNextPage) {
  ...
  <div class="flex h-screen ">
	...
	<aside class="hidden h-[calc(100vh-0px)] w-80 flex-shrink-0 transform bg-white shadow-xl transition-transform duration-300 ease-in-out lg:block">
	  <div class="h-full overflow-y-auto p-6  md:py-10">
		<!-- Filter Content -->
		<div class="py-2">
		...
		<div class="py-2">
		  <h2 class="mb-4 text-2xl font-bold text-[#30363C]">Occasions</h2>
		  <div class="space-y-3">
	...
	<!-- Main Content Area -->
		...
		<div class="w-full">
		  ...
		  {#if productsLoading && !$productsQuery.isFetchingNextPage}
