    ...
    <div class="col-span-2 md:col-span-1">
          ...
          {:else}
            <ul class="space-y-2">
              {#each categories as category}
                <li>
                  <a href={`/Products/?${category._id}`} class="lg:text-lg text-base  hover:underline text-white">
                    {category.name}
                  </a>
                </li>
              {/each}
              <li>
                <a href="/Products" class="lg:text-lg text-base  text-white hover:underline">View More</a>
              </li>
            </ul>
          {/if}
        {/if}
      ...
      <div class="lg:pl-10 pl-0">
        ...
        <ul class="space-y-2 text-white">
          <li>
            <a href="/address-management" class="lg:text-lg text-base hover:underline">Address Management</a>
          </li>
          <li>
          ...
          <li>
            <a href="/cart" class="lg:text-lg text-base hover:underline">Cart</a>
          </li>
          <li>
            <a href="/privacy-policy" class="lg:text-lg text-base hover:underline">Privacy Policy</a>
          </li>
          <li>
            <a href="/terms-and-conditions" class="lg:text-lg text-base hover:underline">Terms & Conditions</a>
          </li>
        </ul>
      </div>
...
<div class="border-t bg-custom-gradient py-2 flex-col md:flex-row flex items-center justify-center   !border-gray-100/30">
  <p class="text-white">
    <a href="https://www.wenoxo.in/">
      <span class="text-white text-sm">© 2025 Wenoxo Technologies. All rights reserved. </span> 
    </a>
